<x-app-layout title="Bukti Daftar Pendiksaan" is-header-blur="true">
    <main class="main-content w-full px-[var(--margin-x)] pb-8" x-data="pages.Lapordiksa.laporandiksa">
            ...
            <div class="card px-5 py-12 sm:px-18">
                <div class="flex flex-col justify-between sm:flex-row">
                    ...
                    <div class="mt-4 text-center pt-2 sm:m-0 sm:text-right">
                        ...
                        <div class="space-y-1 ">
                            <p>
                                Dibuat: <span id="createdate" class="font-semibold"></span>
                            </p>
                            <p class="text-lg font-medium text-slate-600 dark:text-navy-100">
                                Periode  : 
                            </p>
                            <p class="font-medium" id="tglperiod"></p>
                          
                        </div>
                    </div>
                </div>
                <div class="my-7 h-px bg-slate-200 dark:bg-navy-500"></div>
                <div class="is-scrollbar-hidden min-w-full overflow-x-auto" x-data="pages.laporandiksa.lapordiksa">
                    <h3 class="font-medium text-xl text-center">Laporan Pendiksaan </h3>
                    <table class="is-zebra w-full text-left mt-4">
                        ...
                        <tbody id="datalapdiksa">
                         
                        </tbody>
                        
                    </table>
                    <h1 id="jadwalks" class="font-bold text-xl text-center text-black"> </h1>
                </div>  
                    ...
                    <div class="flex flex-col justify-between sm:flex-row">
                        ...
                        <div class="mt-4 text-center sm:m-0 sm:text-right" id="totaldiksa">
