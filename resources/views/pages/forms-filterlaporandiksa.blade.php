<x-app-layout title="Input Kategori Kegiatan" is-header-blur="true">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8" x-data="pages.filterdiksa.filterdiksaconfig">
          ...
          <div class=" grid col-span-12 lg:col-span-12">
            ...
            <div class="card mt-3">
              <div class="is-scrollbar-hidden min-w-full overflow-x-auto">
                <table class="w-full text-left" id="datatablediksav3">
                  <thead>
                    <tr>
                      <th
