            ...
            <div class="card px-5 py-12 sm:px-18">
                ...
                <div class="is-scrollbar-hidden min-w-full overflow-x-auto" x-data="pages.tablediksa.datadiksa">
                    <div class="flex flex-row justify-between">
                        <div>
                            <div class="mt-2">
                                <p class="text-sm+ font-semibold text-slate-600 dark:text-navy-100">
                                    Acara :
                                </p>
                                <div class="space-y-1 pt-2">
                                    <p class="font-semibold">Kamp Belajar Malaikat Kecil</p>
                            ...
                            <div class="mt-2">
                                ...
                                <div class="space-y-1 pt-2">
                                    <p class="font-medium">Senin , 12-JUN-2022</p>
                                </div>
                            </div>
                            <div class="mt-2">
                                <p class="text-sm+ font-semibold text-slate-600 dark:text-navy-100">
                                ...
                                <div class="space-y-1 pt-2">
                                    <ul class="list-disc ml-9">
                                        <li>Umur : 7-14 Tahun</li>
                                        <li>Pakaian Seragam kegiatan vihara/baju sopan rapi</li>
                                    </ul>       
                                </div>
                            </div>
                        </div>
                        <div class="flex flex-col justify-center items-center space-y-4">
                            <p class="text-center font-bold ">Scan Here :</p>
                           {{-- <img  src="data:image/png;base64,{{ DNS2D::getBarcodePNG('4445645656', 'QRCODE',8,8)  }}" alt="barcode"   /> --}}
                           {!!DNS2D::getBarcodeHTML('kau jelek !!', 'QRCODE')!!}
                            <h2>Scan Untuk Melihat Informasi Vihara </h2>
                        </div>
                    </div>
                </div>  
