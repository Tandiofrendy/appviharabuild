<x-app-layout title="Laporan Kegiatan" is-header-blur="true">
    <main class="main-content w-full px-[var(--margin-x)] pb-8"  x-data="pages.settingkeg.settingkegiatan">
        <div class="flex items-center justify-between py-5 lg:py-6">
            <input type="hidden" id="tglkeg" value={{$data}}/>
            ...
            <div class="card px-5 py-12 sm:px-18">
                <div class="flex flex-col justify-between sm:flex-row">
                    ...
                    <div class="mt-4 text-center pt-2 sm:m-0 sm:text-right">
                        <div class="space-y-1 ">
                            <p>
                                Dibuat: <span class="font-semibold">MARET 3, 2023</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                {{-- <div class="flex flex-col justify-between sm:flex-row">
                    ...
                    <div class="mt-4 text-center sm:m-0 sm:text-right">
                        ...
                        <div class="space-y-1 pt-2">
                            <p class="font-medium">Min,10-Agustus-2020</p>
                        </div>
                    </div>
                </div> --}}
                <div class="my-7 h-px bg-slate-200 dark:bg-navy-500"></div>
                <div class="is-scrollbar-hidden min-w-full overflow-x-auto" x-data="pages.tablelaporankegiatan.datalaporankegiatan">
                    <h3 class="font-medium text-xl text-center">DAFTAR KEGIATAN BULAN <p id="bulan" class="font-bold text-xl ">SEMUA JADWAL</p></h3>
